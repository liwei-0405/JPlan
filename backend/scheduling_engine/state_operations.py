...
class StateOperationsMixin:
    ...
    def _format_activity(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "location_policy": item.get("location_policy") or item.get("locationPolicy"),
            ...
            "location_flexible": bool(item.get("location_flexible", False)),
            "can_be_done_at_current_location": bool(item.get("can_be_done_at_current_location", False)),
            "quiet_place_required": bool(item.get("quiet_place_required", False)),
            "activity_role": item.get("activity_role"),
            "travel_context_required": bool(item.get("travel_context_required", False)),
            "semantic_constraint_type": item.get("semantic_constraint_type"),
            ...
            "earliest_preferred_start": item.get("earliest_preferred_start"),
            "latest_preferred_end": item.get("latest_preferred_end"),
            "ideal_start": item.get("ideal_start"),
            "ideal_end": item.get("ideal_end"),
            "ideal_start_range": deepcopy(item.get("ideal_start_range")) if isinstance(item.get("ideal_start_range"), (list, tuple)) else item.get("ideal_start_range"),
            "acceptable_start": item.get("acceptable_start"),
            "acceptable_end": item.get("acceptable_end"),
            "acceptable_start_range": deepcopy(item.get("acceptable_start_range")) if isinstance(item.get("acceptable_start_range"), (list, tuple)) else item.get("acceptable_start_range"),
            "preference_weight": item.get("preference_weight"),
            "preference_priority": item.get("preference_priority"),
            "preference_type": item.get("preference_type"),
            "is_hard_window": bool(item.get("is_hard_window", False)),
            "is_soft_window": bool(item.get("is_soft_window", False)),
